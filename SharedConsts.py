...
PATH2BACTERIAS_LIST = r'/bioseq/data/results/genomedownload/SavedObjects/ncbi_bacterias.list' 
...
PATH_2_DOWNLOAD_SCRIPT = r"/groups/pupko/estykatzeff/genomedownload/PBS_process/download_genomes_entrez.py"
